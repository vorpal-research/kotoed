...
abstract class Configuration : Jsonable {
    ...
    operator fun <T> (() -> T).getValue(thisRef: Configuration, prop: KProperty<*>): T =
            internalData.getValue(prop.name) as? T ?: this()
