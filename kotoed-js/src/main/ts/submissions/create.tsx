...
import {Alert, Button, Form, FormGroup, ControlLabel, FormControl, Modal, Radio, SplitButton, MenuItem} from "react-bootstrap";
...
export class SubmissionCreate extends React.Component<SubmissionCreateProps, SubmissionCreateState> {
    ...
    render() {
        return <div>
            <SplitButton bsSize="lg" bsStyle="success" title="Submit" onClick={() => this.tryCreate()} id="submit-dropdown">
