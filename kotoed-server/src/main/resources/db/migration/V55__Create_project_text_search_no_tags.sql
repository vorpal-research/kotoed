create or replace function create_project_restricted_text_view() returns VOID
LANGUAGE SQL
AS $$
DROP VIEW IF EXISTS project_restricted_text_search CASCADE;

CREATE VIEW project_restricted_text_search AS
  SELECT
    project.*,
...
SELECT create_project_restricted_text_view();
